...
namespace ChatCloud
{
    [Activity(Label = "InviteYourFriendsActivity")]
    public class InviteYourFriendsActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.InviteYoursFriendslayout);
        ...
        {
            SupportActionBar.SetTitle(Resource.String.sInvite_Your_Friends);
            base.OnResume();
        }
    }
}