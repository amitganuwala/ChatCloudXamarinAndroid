...
{
    [Activity(Label = "ChatGroupsActivity")]
    public class ChatGroupsActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.ChatGroupslayout);
        ...
        {
            SupportActionBar.SetTitle(Resource.String.sChatGroups);
            base.OnResume();
        }
    }
}