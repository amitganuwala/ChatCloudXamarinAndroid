...
namespace ChatCloud
{
    [Activity(Label = "DirectChatActivity")]
    public class DirectChatActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.DirectChatlayout);
        ...
        {
            SupportActionBar.SetTitle(Resource.String.sDirectChat);
            base.OnResume();
        }
    }
}